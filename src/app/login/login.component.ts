  ...
  @ViewChild('closebutton') closebutton;
    ...
    doLogin() {
        ...
        if (this.loginData.user.trim() == '' || !this.valiemail.test(this.loginData.user)) {
            ...
            loginData['userType'] = 'vendoradmin';
            ...
            this._appservice.doLogin(loginData)
                .subscribe((Response) => {
                    ...
                    if (Response.success) {
                        ...
                        localStorage.setItem('vendoradminemail', Response.response_data.userDetails.email);
                        localStorage.setItem('vendoradminId', Response.response_data.userDetails.id);
                        localStorage.setItem('vendorId', Response.response_data.userDetails.vendorId);
                        localStorage.setItem('vendoradmintoken', Response.response_data.authToken);
                        this._router.navigate(['/dashboard']);
                        location.reload();
                     } else {
